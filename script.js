document.addEventListener("DOMContentLoaded", () => {
  ...
  // ID.jsonを読み込む
  function loadIds() {
    return fetch("https://yuyuyu-made-bbs.onrender.com/ID.json")
      .then((res) => {
  ...
  // 投稿取得＆表示
  function fetchPosts() {
    fetch("https://yuyuyu-made-bbs.onrender.com/api")
      .then((res) => {
  ...
  postForm.addEventListener("submit", (e) => {
    ...
    fetch(`https://yuyuyu-made-bbs.onrender.com/api?name=${encodeURIComponent(name)}&pass=${encodeURIComponent(pass)}&content=${encodeURIComponent(content)}`, {
      method: "POST",
    })
      .then((res) => {
